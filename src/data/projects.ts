...
export const freelancingProjects: FeaturedProjectType[] = [
  ...
  { 
    ...
    descriptionMobile: "AI-powered system automating bank regulatory processes with modular, adaptive components that explain reasoning and suggest code updates.",
    role: "Full-stack Developer",
  ...
  { 
    id: "oryza-twitch-overlay",
    index: 2,
    preview: video_preview,
    name: "Oryza Twitch Overlay",
    role: "Full-stack Developer",
    description: "For Oryza, I developed an AI-powered Twitch overlay that intelligently highlights key messages from busy chat streams. The system uses natural language processing to surface important viewer interactions—such as questions, moderation triggers, and standout comments—in real time. A collaborative control panel allows the streamer and their team to adjust overlay settings on the fly, with changes instantly reflected across all users. The panel also supports custom AI prompts, enabling fine-tuned message filtering tailored to each stream’s unique context. This project showcases my ability to build responsive, collaborative AI tools that enhance live engagement and community moderation.",
    descriptionMobile: "AI-powered Twitch overlay with NLP for real-time chat highlighting and a collaborative control panel for customizable, responsive stream moderation.",
    date: "May 2025",
    stack: ["SiReact"],
    client: "",
    projectLink: "https://oryza.tudu.dev",
    clientLogo: "",
  },
]
