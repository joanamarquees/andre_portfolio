...
export const freelancingProjects: FeaturedProjectType[] = [
  { 
    ...
    descriptionMobile: "Shopify-integrated browser extension built with Cloudflare tools for scalable, API-driven shared shopping, showcasing independent development and rapid tech adaptation.",
    role: "Full-stack Developer",
    date: "February 2025 - May 2025",
    stack: ["SiReact", "SiShopify", "SiRemix", "SiCloudflare"], // add multisynq icon, or arrows diverging
    client: "ALMA",
    projectLink: "https://alma.dev/",
    clientLogo: alma,
  },
  { 
    id: "smartreg",
